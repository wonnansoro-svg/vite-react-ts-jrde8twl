...
// Interface pour structurer les données météo
...
export default function App() {
    ...
    <div className="bg-white border-t border-gray-200 flex justify-around items-center p-2 pb-4 text-[10px] text-gray-500">
      <button
        ...
        className={`flex flex-col items-center ${
          activeTab === 'dashboard' ? 'text-green-600 font-bold' : ''
        }`}
      >
      ...
      <button
        ...
        className={`flex flex-col items-center ${
          activeTab === 'weather' ? 'text-green-600 font-bold' : ''
        }`}
      >
      ...
      <button
        ...
        className={`flex flex-col items-center ${
          activeTab === 'chat' ? 'text-green-600 font-bold' : ''
        }`}
      >
      ...
      <button
        ...
        className={`flex flex-col items-center ${
          activeTab === 'alert' ? 'text-red-600 font-bold' : ''
        }`}
      >
  ...
  const DashboardScreen: React.FC = () => {
    if (isProfileOpen) return <AccountScreen />;

    return (
      <div className="flex flex-col h-full bg-gray-100 overflow-y-auto">
        {/* Header transparent superposé sur la carte avec accès Profil */}
        <div className="absolute top-0 w-full z-20 flex justify-between items-center p-4 bg-gradient-to-b from-black/70 to-transparent">
          ...
          >
            <img
              ...
              alt="[Image de Profil Agriculteur]"
              className="w-full h-full object-cover"
            />
          </button>
        </div>

        {/* Simulation Google Earth Interactive Repensée (Plus grande) */}
        <div className="relative h-[45%] min-h-[300px] bg-blue-100 flex-shrink-0 border-b-4 border-green-600 rounded-b-3xl shadow-md overflow-hidden">
          ...
          {/* Délimitation de la parcelle tracée par l'agriculteur */}
          <svg
            className="absolute inset-0 w-full h-full pointer-events-none"
            preserveAspectRatio="none"
          >
            <polygon
              points="40,90 260,70 330,220 160,280 20,200"
              fill="rgba(34, 197, 94, 0.25)"
              stroke="#22c55e"
              strokeWidth="3"
              strokeDasharray="5 5"
            />
            {/* Points d'ancrage du dessin */}
            <circle
              cx="40"
              cy="90"
              r="6"
          ...
          <div className="absolute bottom-1/4 right-1/4 w-20 h-20 bg-red-500 rounded-full mix-blend-multiply filter blur-xl opacity-90 text-white flex justify-center items-center font-bold text-xs">
            <AlertTriangle className="animate-pulse" />
          </div>

          {/* Contrôles Google Earth simulés */}
          <div className="absolute right-3 bottom-6 flex flex-col space-y-2 z-10">
            <button className="bg-white/95 p-2.5 rounded-xl shadow-lg text-gray-700 hover:bg-gray-50">
              <Layers size={22} />
            </button>
            <div className="bg-white/95 rounded-xl shadow-lg flex flex-col overflow-hidden">
              <button className="p-2.5 border-b hover:bg-gray-50">
          ...
          {/* Santé Globale Badge (Plus imposant, en bas à gauche) */}
        ...
        <div className="p-4 flex flex-col space-y-5">
          {/* État des plantes (Visuel) */}
          <div>
            <h3 className="text-sm font-bold text-gray-800 mb-3 flex items-center">
              <Leaf className="mr-2 text-green-600" size={18} /> État de mes
              cultures
            </h3>
            <div className="flex space-x-3 overflow-x-auto pb-2 scrollbar-hide">
              ...
              <div className="min-w-[120px] bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-2 text-center">
                  ...
                  <span className="bg-green-100 text-green-700 text-[10px] font-bold px-2 py-1 rounded-full flex items-center justify-center">
                    ✅ En forme
                  </span>
                </div>
              </div>
              ...
              <div className="min-w-[120px] bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-2 text-center">
                  ...
                  <span className="bg-orange-100 text-orange-700 text-[10px] font-bold px-2 py-1 rounded-full flex items-center justify-center">
                    ⚠️ À surveiller
                  </span>
                </div>
              </div>
          ...
          {/* Zones Critiques & Alertes */}
          <div>
            <h3 className="text-sm font-bold text-red-600 mb-3 flex items-center">
              <AlertTriangle className="mr-2" size={18} /> Zones Critiques &
              Alertes
            </h3>

            <div className="bg-white rounded-xl shadow-sm border-l-4 border-red-500 p-3 flex items-center space-x-3">
              <img
                src="https://images.unsplash.com/photo-1599596638426-38290f96f014?auto=format&fit=crop&q=80&w=150"
                alt="[Image de Chenille]"
              ...
              <div className="flex-grow">
                ...
                <p className="text-xs text-gray-500 leading-tight mt-1">
                  Parcelle Maïs Sud. Traitement urgent requis.
                </p>
                <button
                  onClick={() => setActiveTab('alert')}
                  className="mt-2 text-xs bg-red-100 text-red-700 font-bold px-2 py-1 rounded w-full"
                >
                  Voir l'Alerte
                </button>
              </div>
  ...
  // Écran 2 : Météo Intelligente
  const WeatherScreen: React.FC = () => {
    // Utilisation de l'interface ForecastItem définie en haut du fichier
    const forecast: ForecastItem[] = [
      {
        day: "Aujourd'hui",
        temp: '32°C',
        icon: <Sun className="text-orange-500" size={32} />,
        action: 'PULVÉRISATION OK',
        actionColor: 'bg-green-100 text-green-700 border-green-500',
        desc: 'Temps clair. Bon pour traiter les feuilles.',
      },
      {
        day: 'Demain',
        temp: '28°C',
        icon: <CloudRain className="text-blue-500" size={32} />,
        action: 'SEMIS CONSEILLÉ',
        actionColor: 'bg-blue-100 text-blue-700 border-blue-500',
        desc: 'Pluie attendue. Le sol sera parfait pour semer.',
      },
      {
        day: 'Mercredi',
        temp: '30°C',
        icon: <Wind className="text-gray-500" size={32} />,
        action: 'INTERDIT : TRAITEMENT',
        actionColor: 'bg-red-100 text-red-700 border-red-500',
        desc: "Vents très forts. Les produits vont s'envoler.",
        badIcon: <Ban size={16} className="mr-1 inline" />,
      },
      {
        day: 'Jeudi',
        temp: '34°C',
        icon: <ThermometerSun className="text-red-500" size={32} />,
        action: 'ATTENTION : CHALEUR',
        actionColor: 'bg-orange-100 text-orange-700 border-orange-500',
        desc: 'Ne pas travailler au champ à midi.',
      },
      {
        day: 'Vendredi',
        temp: '31°C',
        icon: <Cloud className="text-gray-400" size={32} />,
        action: 'RÉCOLTE POSSIBLE',
        actionColor: 'bg-green-100 text-green-700 border-green-500',
        desc: 'Temps nuageux et doux.',
      },
    ];
      ...
      <div className="flex flex-col h-full bg-gray-50 overflow-y-auto">
        ...
        <div className="p-3 space-y-3 pb-6">
          {forecast.map((item, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-3 shadow-sm border border-gray-100 flex items-center space-x-4"
            >
              {/* Colonne Icône & Température */}
              ...
              {/* Colonne Conseil d'Action */}
              <div className="flex-grow">
                <div
                  className={`text-xs font-black uppercase px-2 py-1 rounded border ${item.actionColor} inline-flex items-center mb-1`}
                >
  ...
  const ChatScreen: React.FC = () => (
    <div className="flex flex-col h-full bg-[#E5DDD5]">
      ...
      <div className="flex-grow p-4 overflow-y-auto space-y-4 flex flex-col">
        ...
        <div className="self-end bg-[#DCF8C6] p-3 rounded-lg rounded-tr-none max-w-[80%] shadow-sm border border-green-100">
          <p className="text-gray-800 text-sm">
            Pourquoi ma zone nord est rouge sur la carte ?
          </p>
        ...
        <div className="self-start bg-white p-3 rounded-lg rounded-tl-none max-w-[85%] shadow-sm border border-gray-100">
          <p className="text-gray-800 text-sm mb-2">
            Bonjour ! J'ai analysé la zone. Le rouge indique un{' '}
            <strong>stress hydrique important</strong> et un début possible d'
            <strong>Oïdium</strong>.
            <br />
            <br />
            Voulez-vous voir les traitements recommandés pour cette culture ?
          </p>
          ...
          <button className="flex items-center text-xs bg-gray-100 text-gray-700 px-3 py-2 rounded-full font-medium hover:bg-gray-200 transition">
            <Volume2 size={16} className="mr-2 text-green-600" /> Écouter le
            message
          </button>
        ...
        <div className="flex space-x-2 pt-2 overflow-x-auto pb-2 scrollbar-hide">
          <button className="whitespace-nowrap bg-white text-green-700 border border-green-600 px-4 py-1.5 rounded-full text-sm font-medium shadow-sm">
            Comment traiter ?
          </button>
          <button className="whitespace-nowrap bg-white text-green-700 border border-green-600 px-4 py-1.5 rounded-full text-sm font-medium shadow-sm">
            Scanner une feuille
      ...
      <div className="bg-[#F0F0F0] p-3 flex items-center space-x-2">
        ...
        />
        <button className="p-2.5 bg-green-600 text-white rounded-full shadow-sm">
      ...
      <div className="p-4 flex flex-col flex-grow">
        <div className="bg-white rounded-xl shadow-md overflow-hidden border border-red-100 mb-4">
          <div className="bg-red-50 p-3 border-b border-red-100">
            <h3 className="text-red-700 font-black flex items-center text-sm">
              ⚠️ ALERTE CRITIQUE (80%)
            </h3>
            <p className="text-gray-800 font-bold mt-1 text-lg">
              Risque Chenilles Légionnaires
            </p>
          </div>
          ...
          <div className="p-4 space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-700">
                L'humidité actuelle combinée aux fortes chaleurs récentes
                favorisent massivement l'éclosion des larves dans la parcelle
                Sud.
              </p>
            </div>
        ...
        <div className="mt-auto pt-4">
          ...
          <p className="text-center text-xs text-gray-400 mt-2">
            Mise en relation directe avec la coopérative
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-col h-full bg-gray-50 overflow-y-auto animate-in fade-in duration-300">
      <div className="bg-green-700 text-white p-4 pt-6 flex items-center font-bold text-lg shadow-md z-10 sticky top-0">
        <button
          ...
          className="mr-3 p-1.5 hover:bg-green-600 rounded-full transition-colors"
        >
          <ArrowLeft size={24} />
        </button>
        Mon Profil & Forfaits
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mb-1">
              Localisation : Boundiali, Savanes
            </p>
        ...
        <div>
            ...
            <ul className="text-xs text-gray-600 space-y-2 mb-4">
              ...
              <li className="flex items-start">
                <CheckCircle
                  ...
                  className="mr-1.5 text-gray-400 flex-shrink-0"
                />{' '}
                IA Chatbot limité (5 msgs/j)
              </li>
            </ul>
            <button
              className="w-full bg-gray-100 text-gray-500 py-2.5 rounded-lg text-xs font-bold"
              disabled
            >
              Forfait Actif
            </button>
          ...
          <div className="bg-green-50 rounded-xl shadow-md border-2 border-green-500 p-4 mb-3 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-2 mt-2">
              ...
              <div className="text-right">
                ...
                <span className="text-[10px] text-green-600 block leading-none">
                  par mois
                </span>
              </div>
            </div>
            <ul className="text-xs text-gray-700 space-y-2 mb-4 mt-3">
              <li className="flex items-start">
                <CheckCircle
                  size={14}
                  className="mr-1.5 text-green-600 flex-shrink-0"
                />{' '}
              ...
              <li className="flex items-start">
                <CheckCircle
                  ...
                  className="mr-1.5 text-green-600 flex-shrink-0"
                />{' '}
                Images satellites HD (Hebdomadaire)
              </li>
              <li className="flex items-start">
                <CheckCircle
                  size={14}
              ...
              <li className="flex items-start">
                <CheckCircle
                  ...
                  className="mr-1.5 text-green-600 flex-shrink-0"
                />{' '}
                Météo agricole prédictive à 7 jours
              </li>
            </ul>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-xs font-bold text-blue-600 border border-blue-600 px-2 py-1 rounded">
                Sur devis
              </span>
            </div>
            <p className="text-xs text-gray-500 mb-3">
              Pour les groupements agricoles. Tableau de bord centralisé,
              gestion de multiples parcelles et ligne directe avec un agronome.
            </p>
